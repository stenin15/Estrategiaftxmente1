      ...
      {!liberado ? (
        ...
        <section id="resultados" className="bg-gradient-to-b from-[#0a0f14] to-[#071e26] text-white py-16">
          <div className="section-box text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 p-6 rounded-2xl border border-green-400/30 backdrop-blur-sm">
                <h3 className="text-xl font-bold text-green-300 mb-4">📊 Print Real - Binance</h3>
                <div className="bg-gray-900/50 p-4 rounded-lg mb-4 min-h-[200px] flex items-center justify-center border border-gray-600">
                  <img 
                    ...
                    alt="Print Real Binance - Resultado Cripto" 
                    className="max-w-full max-h-full object-contain rounded shadow-lg"
                  />
                </div>
                <div className="text-xs text-gray-400 italic">
                  Resultado real da estratégia TFX - Binance
                </div>
              </div>

              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 p-6 rounded-2xl border border-blue-400/30 backdrop-blur-sm">
                <h3 className="text-xl font-bold text-blue-300 mb-4">📊 Print Real - Forex</h3>
                <div className="bg-gray-900/50 p-4 rounded-lg mb-4 min-h-[200px] flex items-center justify-center border border-gray-600">
                  <img 
                    src="/resultado forex 1  (6).jpeg" 
                    alt="Print Real Forex - Resultado 1" 
                    className="max-w-full max-h-full object-contain rounded shadow-lg"
                  />
                </div>
                <div className="text-xs text-gray-400 italic">
              ...
              <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 p-6 rounded-2xl border border-yellow-400/30 backdrop-blur-sm">
                <h3 className="text-xl font-bold text-yellow-300 mb-4">📊 Print Real - Forex</h3>
                <div className="bg-gray-900/50 p-4 rounded-lg mb-4 min-h-[200px] flex items-center justify-center border border-gray-600">
                  <img 
                    src="/resultado forex 2  (2).jpeg" 
                    alt="Print Real Forex - Resultado 2" 
                    className="max-w-full max-h-full object-contain rounded shadow-lg"
                  />
                </div>
                <div className="text-xs text-gray-400 italic">
